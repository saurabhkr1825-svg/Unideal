            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('No donations yet', style: TextStyle(color: Colors.grey, fontSize: 16)),
                ],
              ),
            );
          }
                ...
                child: ListTile(
                  ...
                  leading: ClipRRect(
                    ...
                    child: product.imageUrl != null 
                      ...
                      : Container(color: Colors.indigo[50], width: 60, height: 60, child: const Icon(Icons.image_outlined, color: Colors.indigo)),
                  ),
